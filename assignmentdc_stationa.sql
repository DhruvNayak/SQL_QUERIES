...
--
-- Table structure for table `stationa`
--

DROP TABLE IF EXISTS `stationa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stationa` (
  `id` int DEFAULT NULL,
...
--
-- Dumping data for table `stationa`
--

LOCK TABLES `stationa` WRITE;
/*!40000 ALTER TABLE `stationa` DISABLE KEYS */;
/*!40000 ALTER TABLE `stationa` ENABLE KEYS */;
UNLOCK TABLES;
