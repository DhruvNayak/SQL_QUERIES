...
CREATE TABLE `products` (
  ...
  `product_desccrp` varchar(200) DEFAULT NULL,
...
INSERT INTO `products` VALUES (1,'TMC cylinder','Production',2),(2,'flush tester','flushing',13),(3,'booster','diaphram based',12);
